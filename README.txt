...
1.0   (05 August 2009) Initial release
1.0.1 (06 August 2009 )plugin now configures itself with a base list of syntax brushes on setup
1.0.2 (10 August 2009) added ActionScript 3 brush
1.0.3 (07 October 2009) fixed a file path bug

2.0 (01 November 2009) Complete refactoring of plugin:
...
2.0.1 (02 January 2010) plugin now highlights code in post excerpts (bug fix)
2.0.2 (30 January 2011) updated ColdFusion brush script. Used one developed by John Whish (see http://www.aliaspooryorik.com/blog/index.cfm/e/posts.details/post/syntaxhighlighter-coldfusion-brush-update-299)